    ...
    def get_prometheus_metric_metadata(self) -> PrometheusMetricMetadata:
        return PrometheusMetricMetadata(
            ...
            median_time_per_output_token=ModelServerPrometheusMetric(
                "llm_time_per_output_token_seconds_bucket",
                "median",
                "histogram",
                self.metric_filters,
            ),
            ...
            total_requests=ModelServerPrometheusMetric(
                "llm_e2e_request_latency_seconds_bucket",
                "increase",
                "counter",
                self.metric_filters,
            ),
            requests_per_second=ModelServerPrometheusMetric(
                "llm_e2e_request_latency_seconds_count",
                "rate",
                "counter",
                self.metric_filters,
            ),
            ...
            num_preemptions_total=ModelServerPrometheusMetric(
                "llm_num_preemptions_total", "mean", "gauge", self.metric_filters
            ),
            ...
            prefix_cache_hits=ModelServerPrometheusMetric(
                "llm_gpu_prefix_cache_hits_total",
                "increase",
                "counter",
                self.metric_filters,
            ),
            prefix_cache_queries=ModelServerPrometheusMetric(
                "llm_gpu_prefix_cache_queries_total",
                "increase",
                "counter",
                self.metric_filters,
            ),
